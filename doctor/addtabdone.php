...
if(isset($_SESSION['docid']))
{
	...
	$d=$data['docbill']+$my['docbill'];
	$q4="UPDATE `patient` SET `docbill`=".$d." WHERE `id`=".$_SESSION['patid'];
	@mysqli_query($con,$q4);
	echo "<center><fieldset><legend><font id='error'>Tablets</font></legend>";
	echo "<font color='#FF0000'>Patient : ".$data['name']."</font>";
	echo "<form method='POST' action='addtabdone.php'>";
	echo "<table>";
